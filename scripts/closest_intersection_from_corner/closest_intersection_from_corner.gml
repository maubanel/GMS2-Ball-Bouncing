			...
			if (A <= .0000001 || DET < 0) 
			{
				...
				show_debug_message("HHHHHHHHHHHHHHHHHHHHHHHHHHHHHEEEEEEEEEEEEEEEEEEEYYYYYYYYYYYYYYYYYYYY");
				return false;
			}
			...
			else // two solutions line could go through circle
			{
				...
				r_angle_x = cos(degtorad(new_dir - 180));
				r_angle_y = -sin(degtorad(new_dir - 180));	
				// Reflection angle
				//R=E−2(E⋅n̂ )n̂ 
